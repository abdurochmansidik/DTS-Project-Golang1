...
func init() {
	...
	conf := &firebase.Config{
		DatabaseURL: "https://labantrianfirebase.firebaseio.com/", //Letakan Link firebaseio disini
	}
	// Fetch the service account key JSON file contents
	opt := option.WithCredentialsFile ("labantrianfirebase-firebase-adminsdk-ykcjp-ed798afba8.json") //Letakan adminsdk.json disini
